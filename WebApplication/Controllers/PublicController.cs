...
namespace WebApplication.Controllers
{
    ...
    public class PublicController : ControllerBase
    {
        ...
        {
            await _dbContex.Exams.AsNoTracking().ToListAsync();
        ...
        {
            public Dictionary<LearnBranch, VersionCheck> v;
        }

        private Catalog _c = new Catalog()
        {
            v = new()
            {
                {
                    ...
                    new VersionCheck()
                    {
                        ...
                        androidUpgradeUrls =
                        [
                            "https://oncodraw.com/toefl-api/api/files2/DownloadFile2/public/0/TestHelperToefl_1.1.63.apk"
                        ],
                    }
        ...
        [AllowAnonymous]
        [HttpGet("versionCheck2/{learnBranch}")]
        public async Task<VersionCheck> versionCheck2([FromRoute]LearnBranch learnBranch)
        {
            var res=_c.v[learnBranch];
            var last = _dbContex.appDownloadFiles.First(x => x.learnBranch == learnBranch && !x.IsRemoved);
            //res.availableFlutter=last.availableFlutter;
            res.androidUpgradeUrls =
                [last.file];
            return res;
        }

...
namespace AdminServer
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IOldDb, ApplicationDbContext>();
            ...
            var types = typeof(ApplicationDbContext).GetProperties().Where(x => x.PropertyType.IsGenericType && x.PropertyType.GetGenericTypeDefinition() == typeof(DbSet<>))
                .Select(y => y.PropertyType.GetGenericArguments()[0]).ToList()
                .Where(x => x.getKeyType() != null)
                .Select(
                   z => typeof(AdminPanelOld.GenericAdminCrudController<,>).MakeGenericType(new Type[] { z, z.getKeyType() })
               ).ToList();
            ...
            services.
                AddMvc(o =>
                {
                    ...
                    o.Conventions.Add(new GenericClientControllerRouteConvention("", types, true));

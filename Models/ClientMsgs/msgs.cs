...
namespace ClientMsgs
{
    ...
    public class SearchContent
    {
        ...
        public List<ExamPartType> examPartTypes { get; set; }
        
        public List<int> examCompanies { get; set; }
    ...
    public class ExaminerRequest
    {
        ...
        public Guid examinerFinder { get; set; }
        


    }
    public class ExaminerAcceptRequest
    {
        //[ForeignKeyAttr(typeof(User))]
        public Guid examinerFinder { get; set; }
    ...
    public class TokenRequestResponse : BooleanResponse
    {
        public string token { get; set; }
    }

    public class UploadResponeFile 
    {
    ...
    public class UploadReviseFile 
    {



        public Guid reviseId { get; set; }
    ...
    public struct SubjectCorectness
    {
        [ForeignKeyAttr(typeof(Subject))]
        public int key { get; set; }
        public double allAnwsers { get; set; }
